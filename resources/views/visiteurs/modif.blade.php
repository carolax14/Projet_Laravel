        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p></p>
                        <form action="/visiteurs/liste" method="post">



                            <div class="mb-3 form-group">
                                <label class="form-label">Nom</label>
                                <input type="text" name="id" value="{{$visiteur->id}}" class="form-control text-uppercase">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input type="text" name="visteur_prenom" value="{{$visiteur->visiteur_prenom}}" placeholder="Prénom..." class="form-control" required>
                            </div>
                            <div class="mb-3 form-group">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <!-- <input href="/visiteurs/liste" type="submit" value="Annuler" name="Annuler" class="btn btn-danger"> -->
                            </div>
